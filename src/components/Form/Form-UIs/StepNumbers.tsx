...
const StepNumbers = ({ page, index, last, onClick }: Props) => {
  return (
    <div
    ...
    >
      <div className=' w-[30px] h-[30px] rounded-full  text-[#636363] border-4 border-[#636363] flex justify-center items-center bg-white'>
        {index + 1}
      </div>
