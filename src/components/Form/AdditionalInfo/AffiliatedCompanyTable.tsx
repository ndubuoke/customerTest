...
import { AffiliatedCompanyDetailsType } from 'Components/Form/Types/AdditionalTypes'
...
const AffiliatedCompanyDetailsTable = memo(
      ...
      <div className={`py-6 w-[987px] overflow-x-auto ${collapsed ? 'max-h-0 overflow-hidden hidden' : 'px-3'}  `}>
        <table className='w-full '>
          <thead>
            <tr className='bg-white h-[60px]'>
              ...
              <th className='  align-middle  text-left font-bold text-[14px] text-[#aaaaaa]   max-w-[255px]   w-[20%] min-w-[155px]'>
                <span className='px-3 border-l-2'>NAME OF COMPANY</span>
              </th>
              <th className='  align-middle  text-left font-bold text-[14px] text-[#aaaaaa]   max-w-[255px]   w-[20%] min-w-[155px]'>
                <span className='px-3 border-l-2'>Parent Company's Country of Incorporation</span>
              </th>
          ...
          <tbody>
            ...
            {details.length > 0
              ? details?.map((x: AffiliatedCompanyDetailsType, i) => {
                  return (
...
export default AffiliatedCompanyDetailsTable
